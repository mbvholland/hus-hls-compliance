...
namespace HlsCompliance.Api.Services
{
    ...
    {
        private const string FileName = "Data/koppelingen.json";
        ...
        private void LoadFromDisk()
        {
            try
            {
                ...
                var list = JsonSerializer.Deserialize<List<KoppelingenResult>>(json, options);
                if (list == null)
                {
                    return;
                }
        ...
        private void SaveToDisk()
        {
            try
            {
                ...
                List<KoppelingenResult> snapshot;
                lock (_syncRoot)
                {
